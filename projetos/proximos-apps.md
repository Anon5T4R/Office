...
**Pendências:** teste do João na v0.1.2 (janela do vídeo + controles do app + atalhos); v0.3 = sinergia "gerar legenda com o LocalScribe" (detecção via registro); miniatura no hover da barra; embed X11 no Linux.
